...
const AgregarForm = ({ setNuevoProducto }) => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch("http://localhost:8080/api/productos/", request)
  ...
  return (
    <div>
      <label
        htmlFor="my-modal-4"
        className="btn btn-secondary w-auto md:w-8/12 my-auto col-span-2 modal-button"
      >
        agregar producto
      </label>
      ...
      <label htmlFor="my-modal-4" className="modal cursor-pointer">
        ...
        <label className="modal-box relative" htmlFor="">
          ...
          <h3 className="text-lg font-bold text-center">Agregar producto</h3>
          <form
